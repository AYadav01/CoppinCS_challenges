...
def makeBrick(available_big_bricks, available_small_bricks, goal):
    ...
    if available_big_bricks != 0:
      ...
      #if required bigger bricks are greater than the available bigger bricks
      elif required_big_bricks >= available_big_bricks:

        #check how much distance could be covered by the available bigger bricks
